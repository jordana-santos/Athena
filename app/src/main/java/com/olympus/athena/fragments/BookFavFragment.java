...
public class BookFavFragment extends Fragment {
    ...
    public static BookFavFragment newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LiveData<PagingData<Livro>> livrosLd = mainViewModel.getBooksFavLd();
        ListaLivroAdapter adapter = new ListaLivroAdapter((MainActivity) getActivity(), new LivroComparator());

        RecyclerView rv = view.findViewById(R.id.rvFavFrag);
