...
public class AthenaRepository {
    ...
    public List<Livro> loadHistBooks(Integer limit, Integer offSet) {

        // cria a lista de produtos incicialmente vazia, que será retornada como resultado
        List<Livro> livrosHistList = new ArrayList<>();
        ...
        // Cria uma requisição HTTP a adiona o parâmetros que devem ser enviados ao servidor
        HttpRequest httpRequest = new HttpRequest(Config.PRODUCTS_APP_URL +"pegar_historico.php", "GET", "UTF-8");
        httpRequest.addParam("limit", limit.toString());
        httpRequest.addParam("offset", offSet.toString());
        ...
        try {
            ...
            Log.i("HTTP HISTORICO RESULT", result);
    ...
    public Livro loadBookDetail(String id) {
        ...
        try {
            ...
            if(success == 1) {
                ...
                String codigoLivro = jsonObject.getString("codigo_livro");
    ...
    public List<Livro> loadSearchBooks(Integer limit, Integer offSet, String pesquisaUsuario) {
        ...
        // Cria uma requisição HTTP a adiona o parâmetros que devem ser enviados ao servidor
        HttpRequest httpRequest = new HttpRequest(Config.PRODUCTS_APP_URL +"pesquisar.php", "GET", "UTF-8");
        httpRequest.addParam("limit", limit.toString());
        httpRequest.addParam("offset", offSet.toString());
        httpRequest.addParam("pesquisaUsuario", pesquisaUsuario);
